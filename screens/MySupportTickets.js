...
const MySupportTicketsScreen = ({ navigation }) => {
            ...
            <Box flex={1} bg={"#f9f9f9"}>
                {/* <HStack style={{ height: 60 }} bg={colorTheme.normal} justifyContent="space-between" alignItems="center" paddingX="4" paddingY="3" space={2}>
                    <HStack alignItems={'center'} space={8}>
                        ...
                        <Text color="#ffffff" fontSize="16" textAlign="center" fontWeight="bold" textTransform="capitalize">{t("My Support Tickets")}</Text>
                    </HStack>
                </HStack> */}
...
export default MySupportTicketsScreen;
