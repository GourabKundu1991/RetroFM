...
const StoryDetailsScreen = ({ navigation, route }) => {
    ...
    const showAd = async () => {
        // Do not show ads for subscribed users
    ...
    }, [playType, episodList, route.params.storyID]);
