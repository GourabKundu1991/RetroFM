...
const StoryListScreen = ({ navigation, route }) => {
    ...
    const getStory = () => {
        AsyncStorage.getItem('userToken').then(val => {
            if (val != null) {
                ...
                formdata.append("sub_category_id", route.params.CateId);
                ...
                apiClient
                    ...
                    .then((responseJson) => {
                        ...
                        console.log("Story:", responseJson);
                        if (responseJson.status == true) {
                            setStoryDetails(responseJson.details[0]);
                            setStoryList(responseJson.details[0].series);
                            setLoading(false);
                        } else {
                            setLoading(false);
